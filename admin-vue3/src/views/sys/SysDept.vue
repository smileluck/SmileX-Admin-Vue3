    ...
    <div class="table-card">
      ...
      >已选择 <a>{{ pageSelectColumn.length }}</a> 项
        ...
        >
            ...
            <el-table-column prop="parentId" label="父级部门，不存在则为0" width="200" />
        ...
        <sys-dept-model ref="pageOperaModel" @refresh="pageList"></sys-dept-model>
    </div>
</template>
...
<script setup>
    ...
    import SysDeptModel from "./modules/SysDeptModel.vue";
