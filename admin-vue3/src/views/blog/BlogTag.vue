<template>
  <div class="table-card">
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="4">
            <el-form-item label="标签名：" prop="tagName">
              <el-input
                v-model.trim="pageSearchFormModel.tagName"
                placeholder="请输入标签名"
              /> </el-form-item
          ></el-col>
          <el-col :span="4">
    ...
    <blog-tag-model ref="pageOperaModel" @refresh="pageList"></blog-tag-model>
  </div>
</template>
...
import BlogTagModel from "./modules/BlogTagModel.vue";
