    ...
    <div class="table-card">
      ...
      >已选择 <a>{{ pageSelectColumn.length }}</a> 项
        ...
        >
            ...
            <el-table-column prop="visitType" label="访问类型，1无限制，2统一密码访问" width="200" />
        ...
        <blog-section-model ref="pageOperaModel" @refresh="pageList"></blog-section-model>
    </div>
</template>
...
<script setup>
    ...
    import BlogSectionModel from "./modules/BlogSectionModel.vue";
