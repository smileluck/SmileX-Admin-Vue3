...
<script setup>
    ...
    const rules = reactive({
        ...
        tagIds:[ { required: true, message: "请选择标签id，以,分割", trigger: "blur" }],
        articleTitle:[ { required: true, message: "请选择文章标题", trigger: "blur" }],
        articleContent:[ { required: true, message: "请选择文章内容", trigger: "blur" }],
        grammarType:[ { required: true, message: "请选择语法类型，1markdown，2html", trigger: "blur" }],
        visitType:[ { required: true, message: "请选择访问类型,1通用类型，2统一密码，3独立密码", trigger: "blur" }],
