    ...
    <div class="table-card">
      ...
      >已选择 <a>{{ pageSelectColumn.length }}</a> 项
        ...
        >
            ...
            <el-table-column prop="grammarType" label="语法类型，1markdown，2html" width="200" />
            <el-table-column prop="visitType" label="访问类型,1通用类型，2统一密码，3独立密码" width="200" />
            <el-table-column prop="password" label="独立密码" width="200" />
        ...
        <blog-article-model ref="pageOperaModel" @refresh="pageList"></blog-article-model>
    </div>
</template>
